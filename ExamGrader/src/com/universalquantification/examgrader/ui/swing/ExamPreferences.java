...
public class ExamPreferences extends javax.swing.JFrame
{
    ...
    private void resetToCurrentSettings()
    {
        ...
        {
            OutputDirectoryLabel.setText("<html>No directory selected. Reports will be "
                + "<br/>created in the same path as the exams PDF.</html>");
        }
    ...
    private void initComponents()
    {
        ...
        OutputDirectoryLabel.setText("<html>No directory selected. Reports will be <br/>created in the same path as the exams PDF.</html>");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
