...
/**
 * an ExamReport is a per-student report of exam results. Takes an instance of
 * an Exam object and writes an HTML document showing the results.
 *
...
public class ExamReport
{
    ...
    /**
     * Instantiates a new ExamReport given a graded exam and a file to write to
     *
    ...
    public ExamReport(Exam exam, Writer writeFile, Reader template)
    {
        ...
        boolean showCorrect = (boolean) PreferencesManager.getInstance().get(
            "show-correct-answers");
        this.scope.put("showCorrect", showCorrect);
        boolean showInorrect = (boolean) PreferencesManager.getInstance().get(
            "show-incorrect-answers");
        this.scope.put("showIncorrect", showInorrect);
        boolean showFullImage = (boolean) PreferencesManager.getInstance().get(
            "show-full-image");
    ...
    public String renderHTML()
    {
        ...
        Mustache mustache = mf.compile(this.template, "Exam Report");
